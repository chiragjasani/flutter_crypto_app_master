        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              FadeInLeft(child: Text('Create Your Cryptocurrency Wallet App', style: TextStyle(color:Colors.cyan[500], fontSize: 45, fontWeight: FontWeight.bold, fontFamily: ''),)),
